...
export function remainingMinutesInOven(actual) {
  return EXPECTED_MINUTES_IN_OVEN - actual;
}
export function preparationTimeInMinutes(numLayers) {
  return PREPARATION_MINUTES_PER_LAYER * numLayers;
}

export function totalTimeInMinutes(numLayers, actual) {
  return preparationTimeInMinutes(numLayers) + actual;
}
/**
