...
def spiral_matrix(matrix_size):
    ...
    # Initialize matrix with zeros using an explicit index to avoid unused variables
    matrix = [None] * matrix_size
    for row_index in range(matrix_size):
        matrix[row_index] = [0] * matrix_size
    ...
    for current_number in range(1, matrix_size * matrix_size + 1):
        ...
        # Change direction if the next cell is invalid or already filled
